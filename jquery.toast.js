...
+function($, window, document, undefined){
  ...
  var loadingSelector = ".toast-content";
  ...
  var Toast = {
    ...
    showToast: function(opt){
      ...
      if(this.options.image !== ""){
        $(loadingSelector).append('<img src="'+this.options.image+'" class="toast-img" alt="toast...">');
      } else {
        $(loadingSelector).append('<span class="toast-icon"></span>');
      ...
      $(loadingSelector).append('<p style="margin:0;"></p>').find('p').html(this.options.title);
